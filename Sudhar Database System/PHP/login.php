	...
	if($rows1)
	{
			...
			if($rows2)
			{
				...
				<p class="text30px">YOUR DATABASE DETAILS ARE</p>
					...
					<tr align="center" class="tabler"><td>
						<form action="delete.php">
							...
							<input div="but" class="main_button" type="submit" value="Delete Data" name="submit">
						</form>
					</td>
					<td><a class='link' href="index.php">Home Page</a></td>
					</tr>
				<?php	
			}
			else
			{
				...
				<a class="link" href="index.php">Login again</a>
				<?php
			}
		...
		else
		{
			?>
				...
				<a class="link" href="register.php">Register yourself</a>
				<?php
		}
}
else
{
	...
	<a class="link" href="index.php">Go to main page</a>
	<?php
}
?>
</table>
